...
if ($Index.asOf -ne "2026-08-02" -or $Index.placeCount -ne 48 -or $Index.prefectureCount -ne 47 -or
    ...
    $Index.availableSourceValueCount -ne 62938 -or $Index.unavailableSourceValueCount -ne 134 -or
    $Index.calculableRatioCount -ne 30457 -or $Index.unavailablePairCount -ne 134 -or
    $Index.zeroDenominatorCount -ne 945 -or $Index.sexTotalMismatchCount -ne 7260) {
