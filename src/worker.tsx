...
const origin = "https://shinki-bairitsu.yhay81.com";
...
const seekersWorkbook = "https://www.mhlw.go.jp/toukei/list/xls/114-1d-07.xlsx";
...
const record = async (c: AppContext, name: string) => {
  const session = (c.req.header("x-shinki-bairitsu-session") ?? "").toLowerCase();
  ...
  await c.env.DB.prepare(
    ...
    .bind(
      ...
      name,
      c.req.header("x-shinki-bairitsu-qa") === "1" ? 1 : 0,
      nowSeconds(),
    )
    .run();
};
...
const Layout = ({
  ...
  <html lang="ja">
    <head>
      ...
      <meta content="#202a34" name="theme-color" />
    ...
    <body>
      <header class="site-header">
        <a aria-label="職種新規求人倍率 ホーム" class="brand" href="/">
...
const IntakeFigure = () => (
  <div
    aria-label="一般事務の新規求人と新規求職申込が左右の搬入口から届き、中央で0.69倍を示す受付図"
    class="intake-board"
    role="img"
  >
    <div class="intake-status" aria-hidden="true">
      <span>2025</span>
      <i />
      <i />
      <b>25 · 一般事務</b>
    </div>
    <div class="intake-docks" aria-hidden="true">
      <div class="intake-lane is-opening">
      ...
      <div class="intake-lane is-seeker">
        <div class="lane-label">
          <span>新規申込</span>
          <strong>879,909</strong>
        </div>
        <div class="conveyor">
          <i />
          <i />
    ...
    <div class="intake-floor" aria-hidden="true">
      <span>全国</span>
      <span>パートを含む常用</span>
      <span>年度内受付</span>
    </div>
...
const HomePage = () => (
  <Layout
    canonical={`${origin}/`}
    description="ハローワークの職種別新規求人数と新規求職申込件数から、73職種、全国・47労働局、2023〜2025年度の新規求人倍率と元件数を最大4地域で比較できます。"
    title="職種別の新規求人倍率を地域比較 | 職種新規求人倍率"
  >
    <main>
      <section class="hero-shell">
        <div class="hero-copy">
          <p class="period-label">2023—2025年度 · ハローワーク</p>
          <h1>新しく届いた求人と申込を、同じ搬入口で。</h1>
          <p class="lead">職種、地域、雇用区分、年度をそろえ、新規受付の2値と倍率を並べます。</p>
      ...
      <section aria-labelledby="compare-title" class="compare-panel">
        ...
        <p class="metric-note" id="metric-note">
          年度内に新たに受け付けた件数です。同じセルの新規求人 ÷ 新規申込で倍率を算出します。
        </p>
      ...
      <aside class="boundary">
        ...
        <div>
          ...
          <p>
            年度内の新規受付件数による比率です。応募数、採用確率、賃金、仕事の質、民間求人を含む労働市場全体は分かりません。
          </p>
        </div>
      </aside>
    </main>
...
const GuidePage = () => (
  <Layout
    ...
    description="職種新規求人倍率の新規求人数、新規求職申込件数、雇用区分、分類不能、0人分母、年度値の読み方を説明します。"
    title="数字の見方 | 職種新規求人倍率"
  >
    <main class="text-page">
      <div class="page-intro">
        <p class="section-kicker">数字の見方</p>
        <h1>新規受付の2値を、同じ条件で。</h1>
        <p>職種、雇用区分、労働局、年度をそろえた2値だけから倍率を算出します。</p>
      </div>
      <section class="ratio-guide" aria-label="新規求人倍率の割り算を示す図">
        <div class="formula-card">
          <div>
            <span>新規求人数</span>
            <strong>208,705</strong>
          </div>
          <b aria-hidden="true">÷</b>
          <div>
            <span>新規求職申込件数</span>
            <strong>66,533</strong>
          </div>
      ...
      <section class="guide-grid">
        <article>
          ...
          <h2>新規求人数</h2>
          <p>
            期間中に新たに受け付けた求人票に記載された採用予定人員です。求人票の件数とは一致しません。
          </p>
        </article>
        <article>
          <span>分母</span>
          <h2>新規求職申込件数</h2>
          <p>
            期間中に新たに受け付けた求職申込みの件数です。固有の求職者数とは一致しない場合があります。
          </p>
        </article>
        <article>
          <span>年度値</span>
          <h2>年度内の新規受付</h2>
          <p>月次の新規受付件数を年度で合計した公表値です。前月からの繰越数は加えません。</p>
        </article>
        <article>
          <span>0人</span>
          <h2>分母が0なら算出なし</h2>
          <p>新規申込が0のセルは無限大と表示しません。未公表値も周辺地域や年度から補いません。</p>
        </article>
      </section>
      <section class="note-panel">
        <h2>分類不能の求職者がいます</h2>
        <p>
          2025年度の全国・パートを含む常用では、新規求職申込件数4,362,423のうち836,948（19.2%）が「分類不能の職業」です。職種別の分母には含まれないため、全体倍率との単純比較や職種ランキングを行いません。
        </p>
...
const SourcePage = () => (
  <Layout
    ...
    description="職種新規求人倍率が利用する厚生労働省の第6表・第7表、対応づけ、欠測、0人分母、分類不能、確認日、利用条件を示します。"
    title="出典とデータ | 職種新規求人倍率"
  >
    <main class="text-page">
      <div class="page-intro">
        ...
        <p>
          第6表の新規求人数と第7表の性計・年齢計による新規求職申込件数を、同じセルへ対応づけました。
        </p>
      </div>
      <section class="source-ledger">
        ...
        <div>
          <span>分子</span>
          <strong>第6表 · 職業別新規求人数</strong>
          <a href={openingsWorkbook}>公式Excel</a>
        </div>
        <div>
          <span>分母</span>
          <strong>第7表 · 職業別新規求職申込件数</strong>
      ...
      <section class="prose-section">
        <h2>行った加工</h2>
        <ul>
          <li>第6表・第7表の2023年度以降3シートから、73の職業中分類だけを抽出しました。</li>
          <li>全国と47労働局、3雇用区分、3年度の31,536組・63,072元値を対応づけました。</li>
          <li>
            雇用区分の常用計がフルタイムとパートの和に一致し、全国計が47労働局の和に一致することを検査しました。
          </li>
          <li>
            第7表は推計せず公式の性計・年齢計を使います。性計が男女の単純合計と異なる7,260セルも性計を優先しました。
          </li>
          <li>134組の未公表値をnullで保持し、945組の新規申込0は倍率を算出しません。</li>
          <li>新規求人と新規申込がそろい分母が正の30,457組だけ、求人 ÷ 申込を画面で算出します。</li>
      ...
      <section class="prose-section">
        <h2>ファイル確認</h2>
        <p>
          2026年8月2日取得。第6表は991,012 bytes、SHA-256:
          99e2cad815251763fdb05265e6a8b0be29d04db9615e997646db402591dca8c2。第7表は22,874,210
          bytes、SHA-256: 83ca2a2cdc31a51f075c057456ee4a7cadea8db63925e890cc711156e62b2be8。
        </p>
      </section>
    </main>
  </Layout>
...
const PrivacyPage = () => (
  <Layout
    ...
    description="職種新規求人倍率の端末保存、匿名利用計測、保持期間、追跡拒否への対応を示します。"
    title="保存と計測 | 職種新規求人倍率"
  >
    <main class="text-page">
      <div class="page-intro">
        ...
        <h1>選んだ地域は、端末に。</h1>
        <p>
          検索語、地域名、職種、年度、雇用区分、新規求人・新規申込件数、倍率をサーバーへ記録しません。
        </p>
      </div>
